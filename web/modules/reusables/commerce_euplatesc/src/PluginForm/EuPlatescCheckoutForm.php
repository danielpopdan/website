...
/**
 * Class EuPlatescCheckoutForm.
 *
 * @package Drupal\commerce_euplatesc\PluginForm
 */
class EuPlatescCheckoutForm extends BasePaymentOffsiteForm {
  ...
  public function buildConfigurationForm(array $form, FormStateInterface $form_state) {
    ...
    /** @var \Drupal\commerce_euplatesc\Plugin\Commerce\PaymentGateway\EuPlatescCheckout $payment_gateway_plugin */
