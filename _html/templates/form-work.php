...
include "modules/header.php";?>
    ...
    <main class="clearfix" role="main">
        ...
        <div class="field--type-entity-reference field--name-field-user field--widget-entity-reference-autocomplete js-form-wrapper form-wrapper" data-drupal-selector="edit-field-user-wrapper" id="edit-field-user-wrapper"><div id="field-user-add-more-wrapper">  
            ...
            <div class="tabledrag-toggle-weight-wrapper"><button type="button" class="link tabledrag-toggle-weight" title="Re-order rows by numerical weight instead of dragging.">Show row weights</button></div>
            <div class="tableresponsive-toggle-columns"><button type="button" class="link tableresponsive-toggle" title="Show table cells that were hidden to make the table fit within a small screen." style="display: none;">Hide lower priority columns</button></div>
            <table id="field-user-values" class="field-multiple-table responsive-enabled" aria-describedby="edit-field-user--description" data-striping="1">
                <thead>
                    <tr>
                        <th colspan="2" class="field-label"><h4 class="label js-form-required form-required">Speakers</h4></th>
                        <th class="tabledrag-hide" style="display: none;">Order</th>
                    </tr>
                </thead>
                <tbody>
                    <tr class="draggable odd">
                        <td class="field-multiple-drag"><a href="#" class="tabledrag-handle" title="Drag to re-order"><div class="handle">&nbsp;</div></a></td>
                        <td>
            ...
            <div id="edit-field-user--description" class="description">Type the username of the speaker, and to add more speakers click "Add another".</div>
            <div class="clearfix field-add-more-submit-wrapper"><input class="field-add-more-submit button js-form-submit form-submit" data-drupal-selector="edit-field-user-add-more" formnovalidate="formnovalidate" type="submit" id="edit-field-user-add-more" name="field_user_add_more" value="Add another item">
                    </div>
                    </div>
                    </div></div>
                    ...
                    <div class="field--type-list-string field--name-field-select-list field--widget-options-select js-form-wrapper form-wrapper session-selection" data-drupal-selector="edit-field-select-list-wrapper" id="edit-field-select-list-wrapper"><div class="js-form-item form-item js-form-type-select form-type-select js-form-item-field-select-list form-item-field-select-list">
                    ...
                    <div class="field--type-list-string field--name-field-duration field--widget-options-buttons js-form-wrapper form-wrapper session-duration" id="session-duration" data-drupal-selector="edit-field-duration-wrapper"><fieldset data-drupal-selector="edit-field-duration" id="edit-field-duration--wrapper" class="fieldgroup form-composite required js-form-item form-item js-form-wrapper form-wrapper" required="required" aria-required="true">
                    <legend>
                    <span class="fieldset-legend js-form-required form-required">Duration</span>
                    </legend>
                    <div class="fieldset-wrapper">
                    <div id="edit-field-duration" class="form-radios"><div class="js-form-item form-item js-form-type-radio form-type-radio js-form-item-field-duration form-item-field-duration">
                    ...
                    <div class="field--type-file field--name-field-file-upload field--widget-file-generic js-form-wrapper form-wrapper" data-drupal-selector="edit-field-file-upload-wrapper" id="edit-field-file-upload-wrapper"><div id="ajax-wrapper"><div class="js-form-item form-item js-form-type-managed-file form-type-managed-file js-form-item-field-file-upload-0 form-item-field-file-upload-0">
                    ...
                    <div class="field--type-list-string field--name-field-select field--widget-options-select js-form-wrapper form-wrapper" data-drupal-selector="edit-field-select-wrapper" id="edit-field-select-wrapper"><div class="js-form-item form-item js-form-type-select form-type-select js-form-item-field-select form-item-field-select session-selection">
                    <label for="edit-field-select" class="js-form-required form-required">Drupal version</label>
                    <select data-drupal-selector="edit-field-select" id="edit-field-select" name="field_select" class="form-select required" required="required" aria-required="true"><option value="_none">- Select a value -</option><option value="7.x">7.x</option><option value="8.x">8.x</option><option value="8.5.x">8.5.x</option></select>
                    </div>
                    <!-- vlad -->
                    <div class="field--type-entity-reference field--name-field-taxonomy-reference field--widget-entity-reference-autocomplete js-form-wrapper form-wrapper session-duration" data-drupal-selector="edit-field-taxonomy-reference-wrapper" id="edit-field-taxonomy-reference-wrapper">      <div class="js-form-item form-item js-form-type-entity-autocomplete form-type-entity-autocomplete js-form-item-field-taxonomy-reference-0-target-id form-item-field-taxonomy-reference-0-target-id">
                    ...
                    <!-- vlad -->
                    <div class="field--type-string-long field--name-field-long-description field--widget-string-textarea js-form-wrapper form-wrapper" data-drupal-selector="edit-field-long-description-wrapper" id="edit-field-long-description-wrapper">      <div class="js-form-item form-item js-form-type-textarea form-type-textarea js-form-item-field-long-description-0-value form-item-field-long-description-0-value">
                    ...
                    <div class="field--type-list-string field--name-field-radio-button field--widget-options-buttons js-form-wrapper form-wrapper session-level" data-drupal-selector="edit-field-radio-button-wrapper" id="edit-field-radio-button-wrapper"><fieldset data-drupal-selector="edit-field-radio-button" id="edit-field-radio-button--wrapper" class="fieldgroup form-composite required js-form-item form-item js-form-wrapper form-wrapper" required="required" aria-required="true">
                    <legend>
                    <span class="fieldset-legend js-form-required form-required">Audience</span>
                    </legend>
                    <div class="fieldset-wrapper">
                    <div id="edit-field-radio-button" class="form-radios"><div class="js-form-item form-item js-form-type-radio form-type-radio js-form-item-field-radio-button form-item-field-radio-button">
                    ...
                    <div class="field--type-boolean field--name-field-agree field--widget-boolean-checkbox js-form-wrapper form-wrapper" data-drupal-selector="edit-field-agree-wrapper" id="edit-field-agree-wrapper"><div class="js-form-item form-item js-form-type-checkbox form-type-checkbox js-form-item-field-agree-value form-item-field-agree-value">
                    ...
                    <div class="field--type-string field--name-field-node-id field--widget-string-textfield js-form-wrapper form-wrapper" data-drupal-selector="edit-field-node-id-wrapper" id="edit-field-node-id-wrapper">      <div class="js-form-item form-item js-form-type-textfield form-type-textfield js-form-item-field-node-id-0-value form-item-field-node-id-0-value">
